...
1. Upload the project contents to a **public** GitHub repository. Do not upload `local.properties`, `.gradle/`, `.gradle-user-home/`, `.idea/`, `build/`, `local-debug.keystore`, or the SDK AAR.
2. Create a GitHub Release with tag `v1.7` and attach `release/glyph-composite-toy-v1.7.apk`.
...
The ready-to-test APK is included at [`release/glyph-composite-toy-v1.7.apk`](release/glyph-composite-toy-v1.7.apk). It is intended for personal installation and Glyph Toy testing. A separately signed release APK should be used for Play Store publication.
